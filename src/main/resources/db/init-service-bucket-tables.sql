...
COMMENT ON COLUMN BUCKET_INSTANCE.INITIAL_BALANCE IS 'Starting balance (> 9,999,999,999 for test data, NULL for unlimited buckets)';
COMMENT ON COLUMN BUCKET_INSTANCE.CURRENT_BALANCE IS 'Current remaining balance (NULL for unlimited buckets)';
