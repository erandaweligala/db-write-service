...
-- ============================================================================
-- BUCKET_INSTANCE Sequence for Batch Insert Operations
-- ============================================================================
-- This sequence is used for generating unique IDs during batch insert operations
-- The table itself uses GENERATED BY DEFAULT AS IDENTITY, which allows:
-- 1. Automatic ID generation when ID is not provided (regular inserts)
-- 2. Manual ID specification using this sequence (batch inserts)
-- ============================================================================
...
COMMENT ON SEQUENCE BUCKET_INSTANCE_SEQ IS 'Sequence for generating unique IDs for BUCKET_INSTANCE batch inserts';
